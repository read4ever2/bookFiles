...
public class ABList<T> implements ListInterface<T> {
  ...
  public void add(int index, T element)
    ...
    if ((index < 0) || (index > size()))
      throw new IndexOutOfBoundsException(
          "Illegal index of " + index + " passed to ABList add method.\n");
  ...
  public T set(int index, T newElement)
    ...
    if ((index < 0) || (index >= size()))
      throw new IndexOutOfBoundsException(
          "Illegal index of " + index + " passed to ABList set method.\n");
  ...
  public T remove(int index)
    ...
    if (numElements - 1 - index >= 0)
      System.arraycopy(elements, index + 1, elements, index, numElements - 1 - index);
    elements[numElements - 1] = null;
    numElements--;
    return hold;
  }
  ...
  public Iterator<T> iterator()
    ...
    return new Iterator<>() {
      ...
      public T next()
        ...
        if (!hasNext())
          throw new IndexOutOfBoundsException(
              "Illegal invocation of next " + " in ABList iterator.\n");
        previousPos++;
      ...
      public void remove()
        ...
        if (numElements - 1 - previousPos >= 0)
          System.arraycopy(
              elements, previousPos + 1, elements, previousPos, numElements - 1 - previousPos);
        elements[numElements - 1] = null;
        numElements--;
        previousPos--;
      }
