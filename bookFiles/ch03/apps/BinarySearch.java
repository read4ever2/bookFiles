...
public class BinarySearch {
  ...
  static void initValues()
    ...
    values[0] = 0;
    for (int index = 1; index < SIZE; index++) values[index] = values[index - 1] + rand.nextInt(4);
  }
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        values[SIZE / 2] + " is in array: " + binarySearchIterative(values[SIZE / 2], 0, SIZE - 1));
    System.out.println(
        values[SIZE - 1] + " is in array: " + binarySearchIterative(values[SIZE - 1], 0, SIZE - 1));
    ...
    System.out.println(
        values[SIZE / 2] + " is in array: " + binarySearchRecursive(values[SIZE / 2], 0, SIZE - 1));
    System.out.println(
        values[SIZE - 1] + " is in array: " + binarySearchRecursive(values[SIZE - 1], 0, SIZE - 1));
